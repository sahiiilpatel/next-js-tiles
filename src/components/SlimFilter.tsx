...
import { slimData } from "../data/FilterableData";
  ...
  return (
    <section className="w-full flex flex-col gap-12 py-16 lg:px-16 md:px-10 px-5">
      <div className="flex w-full md:justify-start items-start gap-6 flex-wrap sorting-wrap">
        ...
        <main className="grid lg:grid-cols-2 md:grid-cols-2 gap-x-5 gap-y-8  w-screen filter-grid">
          {slimData.map((item, index) => (
            <div
              key={index}
